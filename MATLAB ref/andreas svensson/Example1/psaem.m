function [ theta ] = psaem( K, N, n_th, u, y, phiv, g, nx, init, prior_V, Q, R, gamma_SA)
%PMH
...
%     Phi1 = sum(ze.*permute(ze,[2 1 3]),3);
    ...
    if k == 1
        ...
        Psi1SA   = gamma_SA(k)*Psi1_bar   + (1-gamma_SA(k))*Psi1SA;
        Sigma1SA = gamma_SA(k)*Sigma1_bar + (1-gamma_SA(k))*Sigma1SA;
    end

    
    % Update new parameters

    Gamma1_star = Psi1SA/Sigma1SA;
    
    theta(:,k+1) = Gamma1_star;
